...
using static Atlas.Tabs.TabDataSettings;

namespace Atlas.UI.Avalonia.Controls;

public class TabControlTreeDataGrid<TModel> : Grid, IDisposable, ITabSelector, ITabItemSelector, ITabDataControl
	where TModel : class
{
	...
	private Dictionary<string, IColumn<TModel>> _columnObjects = new();
	private Dictionary<IColumn<TModel>, string> _columnNames = new();
		...
		set
		{
			...
			foreach (object obj in value)
			{
				if (List!.Contains(obj))
					DataGrid.RowSelection.SelectedItems.Add(obj);
			}
